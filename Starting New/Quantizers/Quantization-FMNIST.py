...
float_model_path = os.path.join("./models/fmnist_model.pt")

out_root         = "./quantized_models/fmnist"
...
class FlowTransformer(nn.Module):
    def __init__(self):
        ...
        self.time_mlp   = nn.Sequential(
            nn.Linear(1, self.embed_dim), nn.SiLU(), nn.Linear(self.embed_dim, self.embed_dim)
        )
